...
const FamilyButtonFilter: React.FC<{ children:React.ReactNode,width: number; height: number }> = ({
  children,
  width,
  height,
}) => {
  ...
  return (
    <div
      className={cn(
        ...
        isExpanded
          ? "bg-gradient-to-b dark:from-neutral-200 dark:to-neutral-100 z-50;"
